...
const ProjectCardDate = [
    {
        imgsrc: pro1,
        title : "EasyMed – Fast Organ Transplant",
        text : "A Google Maps API based application for locating cases of immediate transplantation due to any incident, search the database and find a match which is the closest donor – HTML, CSS, Django, Pandas, NumPy, Graphviz.",
